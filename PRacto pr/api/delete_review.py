...
class handler(BaseHTTPRequestHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            review_id = data.get('id', '').strip()
            if not review_id:
                self._respond(400, {'status': 'error', 'message': 'Missing review id.'})
                return
            ...
            self._respond(200, {'status': 'success', 'message': 'Review deleted successfully.'})
